        ...
        <main>
            ...
            <div class="leyenda">
                <ul>
                    ...
                    <li><i class="fas fa-sign-out-alt"></i>Sale de la aplicación, permite ver el múmnero de accesos, el último acceso y el director puede ver el log</li>                  
                    <li><i class="fas fa-search"></i> Busca un profesor, alumno o curso dependiendo de dónde se encuentre el usuario, los porfesores sólo podrá, ver sus alumnos, sus cursos y su información personal</li>
                </ul>
            </div>
            <h2>Cursos</h2>
            <ul>
